...
namespace eThreadinBar.MobileApp1.Views
{
    ...
    public partial class KorisnickiProfilUredi : ContentPage
    {
        KorisnickiProfilUrediViewModel vm = null;

        public KorisnickiProfilUredi()
        {
            InitializeComponent();
            BindingContext = vm = new KorisnickiProfilUrediViewModel();
        ...
        protected async override void OnAppearing()
        {
            base.OnAppearing();
            await vm.Init();
            this.Gradovi.SelectedItem = vm.GradoviList.FirstOrDefault(s => s.Id == vm.GradID);
        }
